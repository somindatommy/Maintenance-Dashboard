...
function showAnalysis() {
  var spreadSheetApp = SpreadsheetApp;
  var postAnalysisEMAILSheetName = "Post Analysis Weekly set";
  ...
  for (i in data) {
    ...
    if (data[i][4] == DeveloperTeamName) {
      DeveloperTeamData.push([data[i][0], data[i][1], data[i][2], data[i][3]])
      // ui.alert("Developer Data : " + data[i][0] + "  " + data[i][1]);
    }
    if (data[i][4] == ConsumerTeamName) {
      ConsumerTeamData.push([data[i][0], data[i][1], data[i][2], data[i][3]])
      // ui.alert("Developer Data : " + data[i][0] + "  " + data[i][1]);
    }
    if (data[i][4] == CloudTeamName) {
      CloudTeamData.push([data[i][0], data[i][1], data[i][2], data[i][3]])
      // ui.alert("Developer Data : " + data[i][0] + "  " + data[i][1]);
    }
    if (data[i][4] == GatewayTeamName) {
      GatewayTeamData.push([data[i][0], data[i][1], data[i][2], data[i][3]])
      // ui.alert("Developer Data : " + data[i][0] + "  " + data[i][1]);
    }
    if (data[i][4] == EcoTeamName) {
      EcoTeamData.push([data[i][0], data[i][1], data[i][2], data[i][3]])
      // ui.alert("Developer Data : " + data[i][0] + "  " + data[i][1]);
    }
  }
  ...
  if (GatewayTeamData.length > 0) {
    ...
    //ui.alert(GatewayTeamName + " : " + GatewayTeamTable);
  ...
  if (EcoTeamData.length > 0) {
   ...
   // ui.alert(EcoTeamName + " : " + EcoTeamTable);
  ...
  if (CloudTeamData.length > 0) {
   ...
   // ui.alert(CloudTeamName + " : " + CloudTeamTable);
    FinalTeamTable = FinalTeamTable + CloudTeamTable
  }

  Logger.log(" Finale count : " + FinalTeamTable);
  ...
  for (var count = 0; count < analysisTCorder.length ; count = count + 1) {
      ...
      Logger.log(" Finale count : " + count);
      //ui.alert( " Finale tests : " + value);
...
function createTeamTable(teamName, dataArray) {
  var tableHeading = "<table class=\"table\" style=\"width: 100%;\"> <tbody> <tr> <th style=\"width: 20%;\">Update Number</th> <th style=\"width: 10%;\">GIT URL</th> <th style=\"width: 30%;\">Issue summary</th> <th style=\"width: 30%;\">Solution Summary</th> <th style=\"width: 10%;\">Component</th> </tr>";
  ...
  for (var counter = 0; counter < dataArray.length; counter = counter + 1) {
    ...
    if (!isEmpty(analysisEntry)) {
      var data = String(analysisEntry).split(",");
      var rowdata = "<tr>";
      for (i in data) {
        rowdata = rowdata + "<td>" + data[i] + "</td>";
      }
      rowdata = rowdata + "</tr>";
